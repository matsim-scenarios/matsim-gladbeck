...
public class GladbeckOfflineEmissions implements MATSimAppCommand {

    private static final Logger log = LogManager.getLogger(GladbeckOfflineEmissions.class);
    ...
    @CommandLine.Mixin
    private final InputOptions input = InputOptions.ofCommand(GladbeckOfflineEmissions.class);
    @CommandLine.Mixin
    private final OutputOptions output = OutputOptions.ofCommand(GladbeckOfflineEmissions.class);
    @CommandLine.Mixin
    ...
    public static void main(String[] args) throws IOException {
        new GladbeckOfflineEmissions().execute(args);
    }
