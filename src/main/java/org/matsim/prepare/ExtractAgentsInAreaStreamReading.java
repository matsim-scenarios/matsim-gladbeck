...
public class ExtractAgentsInAreaStreamReading {
    ...
    private void initialize(){
        ...
        List<Geometry> geometryStudyArea = ShpGeometryUtils.loadGeometries(IOUtils.resolveFileOrResource(studyAreaShpPath));
        geometryStudyArea = (List<Geometry>) geometryStudyArea.get(0);
