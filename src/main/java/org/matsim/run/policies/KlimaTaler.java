...
public class KlimaTaler implements PersonDepartureEventHandler, AfterMobsimListener, PersonEntersVehicleEventHandler, PersonLeavesVehicleEventHandler, LinkLeaveEventHandler {
    ...
    public KlimaTaler(Network network, double klimaTaler) {
