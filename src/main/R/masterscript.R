...
for (scenario in scenarios){
  ...
  publicSVN <- "/Users/gregorr/Documents/work/respos/runs-svn/glaMobi/"

  runID <- paste0(scenario, "/")

  #base path nur für Sankey und Winner/Loser Analysis
  base.run.path <- "/Users/gregorr/Documents/work/respos/runs-svn/glaMobi/baseCaseContinued"

  region.shp.path <- "/Users/gregorr/Documents/work/respos/shared-svn/projects/GlaMoBi/data/shp-files/shapeFilesUntersuchungsgebiet/dvg2krs_gladbeck-bottrop-gelsenkirchen/study-area.shp"
  city.shp.path <- "/Users/gregorr/Documents/work/respos/shared-svn/projects/GlaMoBi/data/shp-files/Gladbeck.shp"
  cities.area.shp.path <- "/Users/gregorr/Documents/work/respos/shared-svn/projects/GlaMoBi/data/shp-files/shapeFilesUntersuchungsgebiet/dvg2krs_gladbeck-bottrop-gelsenkirchen/dvg2krs_glad-bott-gels.shp"
  ...
  source("/Users/gregorr/Documents/work/respos/git/matsim-gladbeck/src/main/R/masteranalyse.R")
