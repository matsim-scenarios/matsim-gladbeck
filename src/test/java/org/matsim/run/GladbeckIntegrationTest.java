...
public class GladbeckIntegrationTest {
    ...
    private static Population createTestPopulation(Scenario scenario) {
        ...
        Activity originActivity = factory.createActivityFromLinkId("home_600", originLink.getId());
        Activity destinationActivity = factory.createActivityFromLinkId("leisure_600", destinationLink.getId());
